...
- III) [Rédaction des fichiers sources](<3-Writing.fr.md#a22>)
  ...
  - III-4) [Fin de ligne et fin de paragraphe](<3-Writing.fr.md#a28>)
    ...
    - III-4.2) [Piège : texte partagé sur la même ligne qu'une valeur traduite](<3-Writing.fr.md#a30>)
  - III-5) [Blocs multi-lignes (listes, citations, tableaux)](<3-Writing.fr.md#a31>)
  - III-6) [Texte échappé](<3-Writing.fr.md#a32>)
  - III-7) [Texte en citation et barrières de code](<3-Writing.fr.md#a33>)
  - III-8) [Variables](<3-Writing.fr.md#a34>)
  - III-9) [Texte par défaut](<3-Writing.fr.md#a35>)
  - III-10) [Comment éviter les ambiguïtés](<3-Writing.fr.md#a36>)
  - III-11) [Directives](<3-Writing.fr.md#a37>)
  - III-12) [Effets immédiats et englobés](<3-Writing.fr.md#a38>)
  - III-13) [Valeurs et effets par défaut](<3-Writing.fr.md#a39>)
- IV) [Références des directives](<4-Directives.fr.md#a40>)
  - IV-1) [Déclarer les langues: `.languages`](<4-Directives.fr.md#a41>)
    - IV-1.1) [Syntaxe](<4-Directives.fr.md#a42>)
    - IV-1.2) [Remarques](<4-Directives.fr.md#a43>)
    - IV-1.3) [Exemple](<4-Directives.fr.md#a44>)
  - IV-2) [Définition d'un schéma de numérotation : `.numbering`](<4-Directives.fr.md#a45>)
    - IV-2.1) [Syntaxe](<4-Directives.fr.md#a46>)
  - IV-3) [Numéro de titre niveau 1 : `.topnumber`](<4-Directives.fr.md#a47>)
    - IV-3.1) [Syntaxe](<4-Directives.fr.md#a48>)
  - IV-4) [Génération de sommaire : `.toc`](<4-Directives.fr.md#a49>)
    - IV-4.1) [Syntaxe](<4-Directives.fr.md#a50>)
    - IV-4.2) [Exemples](<4-Directives.fr.md#a53>)
  - IV-5) [Texte pour toutes les langues : `.all((`](<4-Directives.fr.md#a54>)
    - IV-5.1) [Syntaxe](<4-Directives.fr.md#a55>)
    - IV-5.2) [Exemples](<4-Directives.fr.md#a56>)
  - IV-6) [Texte par défaut : `.((` ou `.default((`](<4-Directives.fr.md#a57>)
    - IV-6.1) [Syntaxe](<4-Directives.fr.md#a58>)
    - IV-6.2) [Exemples](<4-Directives.fr.md#a59>)
  - IV-7) [Texte ignoré : `.ignore((` ou `.!((`](<4-Directives.fr.md#a60>)
    - IV-7.1) [Syntaxe](<4-Directives.fr.md#a61>)
    - IV-7.2) [Exemple](<4-Directives.fr.md#a62>)
  - IV-8) [Texte pour une langue : `.<code>((`](<4-Directives.fr.md#a63>)
    - IV-8.1) [Syntaxe](<4-Directives.fr.md#a64>)
    - IV-8.2) [Exemples](<4-Directives.fr.md#a65>)
  - IV-9) [Texte échappé : `.!`](<4-Directives.fr.md#a66>)
  - IV-10) [Exemples](<4-Directives.fr.md#a67>)
- V) [Correction des fichiers sources](<5-Debugging.fr.md#a68>)
  - V-1) [NE CORRIGEZ PAS LES FICHIERS GENERES](<5-Debugging.fr.md#a69>)
  - V-2) [Mode trace : `-trace`](<5-Debugging.fr.md#a70>)
  - V-3) [Sections non closes](<5-Debugging.fr.md#a71>)
  - V-4) [Mauvaises indentations](<5-Debugging.fr.md#a72>)
  - V-5) [Langue erronée](<5-Debugging.fr.md#a73>)
  - V-6) [Texte par défaut mal placé](<5-Debugging.fr.md#a74>)
  - V-7) [Listes et tableaux Markdown incohérents](<5-Debugging.fr.md#a75>)
  - V-8) [Mauvaise numérotation des titres](<5-Debugging.fr.md#a76>)
  - V-9) [Disparition de point final](<5-Debugging.fr.md#a77>)
  - V-10) [Orthographe](<5-Debugging.fr.md#a78>)
- VI) [Conclusion](<6-Conclusion.fr.md#a79>)
