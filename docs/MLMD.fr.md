# MLMD - Générateur de Markdown Multilingue<A id="a79"></A>
...
- [MLMD - Générateur de Markdown Multilingue](<#a79>)
- I) [Installation](<1-Installation.fr.md#a1>)
  - I-1) [Version PHP](<1-Installation.fr.md#a2>)
  - I-2) [Emplacement de MLMD](<1-Installation.fr.md#a3>)
  - I-3) [Utilisation d'un alias pour lancer MLMD](<1-Installation.fr.md#a4>)
    - I-3.1) [Linux / macOS / OS X](<1-Installation.fr.md#a5>)
    - I-3.2) [Windows 10](<1-Installation.fr.md#a6>)
- II) [Utilisation de MLMD](<2-Using.fr.md#a7>)
  - II-1) [Paramètres d'exécution MLMD](<2-Using.fr.md#a8>)
  - II-2) [Chemin des fichiers sources](<2-Using.fr.md#a9>)
  - II-3) [Fichiers sources : paramètre `-i`](<2-Using.fr.md#a10>)
  - II-4) [Fichier principal : paramètre `-main`](<2-Using.fr.md#a11>)
  - II-5) [Mode de sortie html/htmlold/md/mdpure : paramètre `-out`](<2-Using.fr.md#a12>)
    - II-5.1) [Ancres HTML nommées : `htmlold`](<2-Using.fr.md#a13>)
    - II-5.2) [Ancres HTML identifiées : `html`](<2-Using.fr.md#a14>)
    - II-5.3) [Ancres Markdown : `md`](<2-Using.fr.md#a15>)
    - II-5.4) [Markdown pur : `mdpure`](<2-Using.fr.md#a16>)
    - II-5.5) [A propos des titres non uniques](<2-Using.fr.md#a17>)
  - II-6) [Numérotation des titres : `-numbering`](<2-Using.fr.md#a18>)
    - II-6.1) [Syntaxe](<2-Using.fr.md#a19>)
    - II-6.2) [Exemple](<2-Using.fr.md#a20>)
- III) [Rédaction des fichiers sources](<3-Writing.fr.md#a21>)
  - III-1) [Début de fichier source](<3-Writing.fr.md#a22>)
  - III-2) [Inclusion de fichiers sources](<3-Writing.fr.md#a23>)
    - III-2.1) [Directive d'inclusion](<3-Writing.fr.md#a24>)
    - III-2.2) [Numérotation des fichiers](<3-Writing.fr.md#a25>)
  - III-3) [Titres](<3-Writing.fr.md#a26>)
  - III-4) [Fin de ligne et fin de paragraphe](<3-Writing.fr.md#a27>)
    - III-4.1) [Notes](<3-Writing.fr.md#a28>)
    - III-4.2) [Piège : texte partagé sur la même ligne qu'une valeur traduite](<3-Writing.fr.md#a29>)
