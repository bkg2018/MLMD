# V) Debugging source files<A id="a68"></A>
...
## V-1) DON'T FIX GENERATED FILES<A id="a69"></A>
...
## V-2) Trace mode: `-trace`<A id="a70"></A>
...
## V-3) Unclosed sections<A id="a71"></A>
...
## V-4) Wrong indentations<A id="a72"></A>
...
## V-6) Misplaced default text<A id="a74"></A>
...
## V-7) Inconsistent Markdown lists and tables<A id="a75"></A>
...
## V-8) Wrong headings numbering<A id="a76"></A>
...
## V-9) Disappearing ending period<A id="a77"></A>
