...
- III) [Writing source files](<3-Writing.md#a22>)
  ...
  - III-4) [End-of-Lines and End-of-Paragraphs](<3-Writing.md#a28>)
    ...
    - III-4.2) [Pitfall: shared text on the same line as a translated value](<3-Writing.md#a30>)
  - III-5) [Multi-line blocks (lists, quotes, tables)](<3-Writing.md#a31>)
  - III-6) [Escaping text](<3-Writing.md#a32>)
  - III-7) [Quoted text and code fences](<3-Writing.md#a33>)
  - III-8) [Variables](<3-Writing.md#a34>)
  - III-9) [Default text](<3-Writing.md#a35>)
  - III-10) [Avoiding ambiguities](<3-Writing.md#a36>)
  - III-11) [Directives](<3-Writing.md#a37>)
  - III-12) [Immediate vs enclosed effect](<3-Writing.md#a38>)
  - III-13) [Default directives values and effects](<3-Writing.md#a39>)
- IV) [Directives Reference](<4-Directives.md#a40>)
  - IV-1) [Declaring languages: `.languages`](<4-Directives.md#a41>)
    - IV-1.1) [Syntax](<4-Directives.md#a42>)
    - IV-1.2) [Notices](<4-Directives.md#a43>)
    - IV-1.3) [Example](<4-Directives.md#a44>)
  - IV-2) [Defining a numbering scheme: `.numbering`](<4-Directives.md#a45>)
    - IV-2.1) [Syntax](<4-Directives.md#a46>)
  - IV-3) [Numbering level 1 heading: `topnumber`](<4-Directives.md#a47>)
    - IV-3.1) [Syntax](<4-Directives.md#a48>)
  - IV-4) [Generating Table Of Content: `.toc`](<4-Directives.md#a49>)
    - IV-4.1) [Syntax](<4-Directives.md#a50>)
    - IV-4.2) [Examples](<4-Directives.md#a53>)
  - IV-5) [Generating for all languages: `.all((`](<4-Directives.md#a54>)
    - IV-5.1) [Syntax](<4-Directives.md#a55>)
    - IV-5.2) [Examples](<4-Directives.md#a56>)
  - IV-6) [Default text: `.default((` or `.((`](<4-Directives.md#a57>)
    - IV-6.1) [Syntax](<4-Directives.md#a58>)
    - IV-6.2) [Examples](<4-Directives.md#a59>)
  - IV-7) [Ignoring text: `.ignore` or `.!((`](<4-Directives.md#a60>)
    - IV-7.1) [Syntax](<4-Directives.md#a61>)
    - IV-7.2) [Example](<4-Directives.md#a62>)
  - IV-8) [Generating for languages: `.<code>((`](<4-Directives.md#a63>)
    - IV-8.1) [Syntax](<4-Directives.md#a64>)
    - IV-8.2) [Examples](<4-Directives.md#a65>)
  - IV-9) [Escaping text: `.!`](<4-Directives.md#a66>)
  - IV-10) [Examples](<4-Directives.md#a67>)
- V) [Debugging source files](<5-Debugging.md#a68>)
  - V-1) [DON'T FIX GENERATED FILES](<5-Debugging.md#a69>)
  - V-2) [Trace mode: `-trace`](<5-Debugging.md#a70>)
  - V-3) [Unclosed sections](<5-Debugging.md#a71>)
  - V-4) [Wrong indentations](<5-Debugging.md#a72>)
  - V-5) [Wrong language](<5-Debugging.md#a73>)
  - V-6) [Misplaced default text](<5-Debugging.md#a74>)
  - V-7) [Inconsistent Markdown lists and tables](<5-Debugging.md#a75>)
  - V-8) [Wrong headings numbering](<5-Debugging.md#a76>)
  - V-9) [Disappearing ending period](<5-Debugging.md#a77>)
  - V-10) [Spellchecking](<5-Debugging.md#a78>)
- VI) [Conclusion](<6-Conclusion.md#a79>)
