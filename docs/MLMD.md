# MLMD - Multilingual Markdown Generator<A id="a79"></A>
...
- [MLMD - Multilingual Markdown Generator](<#a79>)
- I) [Installation](<1-Installation.md#a1>)
  - I-1) [PHP version](<1-Installation.md#a2>)
  - I-2) [Storing MLMD](<1-Installation.md#a3>)
  - I-3) [Using an alias to launch MLMD](<1-Installation.md#a4>)
    - I-3.1) [Linux / macOS / OS X](<1-Installation.md#a5>)
    - I-3.2) [Windows 10](<1-Installation.md#a6>)
- II) [How to Use MLMD](<2-Using.md#a7>)
  - II-1) [MLMD run parameters](<2-Using.md#a8>)
  - II-2) [Source file paths and names](<2-Using.md#a9>)
  - II-3) [Input files: `-i` argument](<2-Using.md#a10>)
  - II-4) [Main file: `-main` argument](<2-Using.md#a11>)
  - II-5) [Output mode html/htmlold/md/mdpure: `-out` argument](<2-Using.md#a12>)
    - II-5.1) [Named HTML anchors: `htmlold`](<2-Using.md#a13>)
    - II-5.2) [Identified HTML anchors: `html`](<2-Using.md#a14>)
    - II-5.3) [Anchored Markdown: `md`](<2-Using.md#a15>)
    - II-5.4) [Pure Markdown: `mdpure`](<2-Using.md#a16>)
    - II-5.5) [About non-unique headings](<2-Using.md#a17>)
  - II-6) [Headings numbering: `-numbering`](<2-Using.md#a18>)
    - II-6.1) [Syntax](<2-Using.md#a19>)
    - II-6.2) [Example](<2-Using.md#a20>)
- III) [Writing source files](<3-Writing.md#a21>)
  - III-1) [Source beginning](<3-Writing.md#a22>)
  - III-2) [Including source files](<3-Writing.md#a23>)
    - III-2.1) [Include directive](<3-Writing.md#a24>)
    - III-2.2) [Numbering main and included files](<3-Writing.md#a25>)
  - III-3) [Headings](<3-Writing.md#a26>)
  - III-4) [End-of-Lines and End-of-Paragraphs](<3-Writing.md#a27>)
    - III-4.1) [Notes](<3-Writing.md#a28>)
    - III-4.2) [Pitfall: shared text on the same line as a translated value](<3-Writing.md#a29>)
